...
three line-number controls style unchanged, added and removed line numbers.
Each covers the complete padded number cell while leaving its vertical divider
alone.
